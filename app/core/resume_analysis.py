...
def extract_country_iso_a2(text: str, allowed_iso_codes_a2: List[str]) -> Tuple[str, str]:
    ...
    try:
        from app.core.resume_analysis import load_spacy_model
        nlp = load_spacy_model()
...
def extract_skills_a2(text: str) -> List[str]:
    ...
    """
    try:
        from app.core.resume_analysis import extract_skills
...
def extract_experience_years_a2(text: str) -> float:
    ...
    try:
        from app.core.resume_analysis import extract_experience_years
...
def extract_resume_features_a2(
    ...
    """
    from app.core.resume_analysis import preprocess_resume_text
