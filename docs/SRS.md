...
This Software Requirements Specification defines the functional and non-functional requirements for SalaryScope v1.4.0 — a machine learning-powered salary prediction web application. It serves as the authoritative reference for the features implemented, the constraints applied, and the behaviour expected from each system component.
