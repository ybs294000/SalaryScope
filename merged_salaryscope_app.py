...
def app1_generate_bulk_pdf(analytics_df):
    ...
    ax.hist(analytics_df["Predicted Annual Salary"], bins=min(12, len(analytics_df)),
    ...
    median_salary2 = analytics_df["Predicted Annual Salary"].median()
    if mean_salary > median_salary2:
        shape_comment = "slightly right-skewed"
    elif mean_salary < median_salary2:
    ...
    hist_text = (
        ...
        f"${median_salary2:,.2f}, indicating the overall central tendency of the predicted salaries."
    )
